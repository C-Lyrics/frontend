...
angular.module('frontendApp').controller('MainCtrl', function ($scope) {
   ...
   //  	val.html = {
   //          onClick: 'window.location.replace("#/Songslist")',
   ...
   //  };
    ...
    // $scope.artists = [
    // 	//will contain artists given from ECHONEST API
    ...
    // }];
	$scope.addtoCloudFunction = function(){

	};
	$scope.sharetoFBFunction = function(){
